...
sha256sums=('5e0b35ac8f46d7bb87e656efd5f9c7c2ac1a6c519a908fc5b581e52657981002'
            ...
            '8488f2185ad3e2582e940cd6e129806da2beb66cc56f94aee95808091841a70e'
            'fabfe76b927cea8b8e70ea3ca28cccdb936ac325421bd534597fa7642a132d5a')
...
prepare () {
  ...
  patch -p1 < ../gfxfonts-fix.patch
  patch -p1 < ../config.h.patch
...
build () {
  ...
  ./configure --prefix=/usr --disable-desktopfiles --with-wx-config=/usr/bin/wx-config
  make
}
